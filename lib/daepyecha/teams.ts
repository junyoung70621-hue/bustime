...
export async function relayPdf(p: RelayPayload): Promise<void> {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      subject,
      text,
      attachments: [{ filename: p.fileName, content: Buffer.from(p.pdf), contentType: "application/pdf" }],
    });
  } catch (e) {
